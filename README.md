...
- **Dual AI Explanations**:
  ...
  - **Cloud Speed (Google Gemini)**: Use Google's Gemini API for lightning-fast, highly accurate explanations.
...
<p align="center">
  <img width="900" alt="Review page" src="https://github.com/user-attachments/assets/6f5e16d2-b37f-489f-9a86-b9345019cb3c">
</p>
...
<p align="center">
  <img width="900" alt="Filtered by pattern" src="https://github.com/user-attachments/assets/dc33c0a4-09bc-47cc-964d-824dc0165e8b">
</p>
...
<p align="center">
  <img width="700" alt="Expanded card 1" src="https://github.com/user-attachments/assets/1a93a111-e5c9-4d27-83dc-462e16978a13">
</p>

<br>

<p align="center">
  <img width="700" alt="Expanded card 4" src="https://github.com/user-attachments/assets/1ac35fe6-b255-453f-b5be-2383600d7acb">
</p>
...
<p align="center">
  <img width="700" alt="Expanded card 3" src="https://github.com/user-attachments/assets/521a1987-8f0c-452c-b102-73eac7cc3a5f">
</p>

<br>

<p align="center">
  <img width="700" alt="Expanded card 2" src="https://github.com/user-attachments/assets/8d0e644e-5b79-4d01-9c04-1518a86d8751">
</p>
...
3. **CRITICAL — Fix CORS:** Ollama blocks cross-origin requests by default. You must start Ollama with the allowed origins environment variable for the Chrome Extension to communicate with it.
   ...
   **Settings panel /  terminal output using ollama:**
   ...
   <p align="center">
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;
     <img width="500" alt="Ollama terminal output" src="https://github.com/user-attachments/assets/d4ec7983-d6dd-406e-a843-3b83451a506e">
   </p>
